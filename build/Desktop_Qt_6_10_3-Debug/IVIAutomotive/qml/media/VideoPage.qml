    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            Rectangle {
                ...
                Layout.preferredHeight: 44
                radius: 22
                color: usbMouse.pressed ? Qt.darker(theme.youtubeAc, 1.2) : (usbMouse.containsMouse ? Qt.lighter(theme.youtubeAc, 1.1) : theme.youtubeAc)
            ...
            Rectangle {
                ...
                Layout.preferredHeight: 44
                radius: 22
                color: folderMouse.pressed ? Qt.darker(theme.bgHover, 1.2) : (folderMouse.containsMouse ? Qt.lighter(theme.bgHover, 1.2) : theme.bgHover)
            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    Rectangle {
                        ...
                        height: 42
                        radius: 21
                        color: prevMouse.pressed ? theme.youtubeAc : (prevMouse.containsMouse ? theme.b2 : theme.b1)

                        Text {
                            anchors.centerIn: parent
                            text: "⏮"
                            font.pixelSize: 18
                            color: prevMouse.pressed ? theme.textOnAccent : theme.t0
                        }
                    ...
                    Rectangle {
                        ...
                        height: 42
                        radius: 21
                        color: nextMouse.pressed ? theme.youtubeAc : (nextMouse.containsMouse ? theme.b2 : theme.b1)

                        Text {
                            anchors.centerIn: parent
                            text: "⏭"
                            font.pixelSize: 18
                            color: nextMouse.pressed ? theme.textOnAccent : theme.t0
                        }
                    ...
                    Rectangle {
                        ...
                        Rectangle {
                            ...
                            height: 20
                            radius: 10
                            color: videoVolMouse.pressed ? theme.youtubeAc : theme.t0
                            border.color: theme.youtubeAc
                            border.width: 2
                            anchors.verticalCenter: parent.verticalCenter
        ...
        Rectangle {
            ...
            ListView {
                ...
                delegate: Rectangle {
                    ...
                    radius: theme.r1
                    color: {
                        if (videoManager.currentIndex === index) return theme.blueDim
                        if (delegateMouseArea.containsMouse) return theme.bgHover
                        return "transparent"
                    }
                    ...
                    RowLayout {
                        ...
                        Rectangle {
                            ...
                            radius: 6
                            color: videoManager.currentIndex === index ? theme.youtubeAc : theme.b1
                            ...
                            Text {
                                ...
                                color: videoManager.currentIndex === index ? theme.textOnAccent : theme.t0
                            }
                        }
                        ...
                        Rectangle {
                            ...
                            Layout.preferredHeight: 34
                            radius: 17
                            color: delegatePlayMouse.containsMouse ? theme.youtubeAc : theme.b1
                            ...
                            Text {
                                ...
                                text: videoManager.currentIndex === index && videoManager.playing ? "⏸" : "▶"
                                font.pixelSize: 13
                                color: delegatePlayMouse.containsMouse ? theme.textOnAccent : theme.youtubeAc
                            }
